...
define(
    ...
    function(){
        function hub_options(opts){
            var _opts = {
                //Host and port of the XMPP Server (only if the server can't be discovered
                //by the domain
                route : opts.route || '',
