...
define(
    ...
    function(Strophe){
        ...
        var errors = {
            ...
            GET_SUBS_FAILED: 'GET_SUBS_FAILED',
            FAILED_REATTACH: 'FAILED_REATTACH',
            CONN_FAIL: 'CONN_FAIL'};
        ...
        hSessionBosh.prototype = {
            ...
            subscribe: function(channel){
                ...
                function _failure(stanza, errorMsg){
                    this.callback({context: 'error', data:
                    {type: 'subscribe', channel: channel, message: errorMsg, msgid: msgId}});
                }
                ...
                function _callbackSubscriptions(stanza){
                    ...
                    if(subs[i].getAttribute('node') != channel){
                        //Not Subscribed
