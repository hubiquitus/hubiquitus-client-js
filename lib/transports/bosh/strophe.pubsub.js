...
if (typeof define !== 'function') {
    ...
    var stropheFile = './strophe.node';
}else{
    var stropheFile = './strophe';
}


define([stropheFile],function(strophe){
    //Running on node
    if(typeof module !== 'undefined' && module.exports){
        strophe = require('./strophe.node').Strophe;
        $iq     = strophe.$iq;
        $pres   = strophe.$pres;
        $build  = strophe.Strophe.$build;
    }
...
// TODO Ideas Adding possible conf values?
    ...
    return { Strophe : Strophe, $iq : $iq, $pres : $pres};
});