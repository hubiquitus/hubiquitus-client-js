...
define(
    ...
    function(codes, sessionStorageAux){
        ...
        hSessionSocketIO.prototype.connect = function(){
            ...
            if(!this.params.stress && typeof sessionStorage.getItem('publisher') === 'string' &&
            ...
            if( !this.params.stress && this.socket ){
                on_socket();
                return;
            }

            this.socket = io.connect(this.params.endpoint, {
        ...
        hSessionSocketIO.prototype.addListeners = function(){
            ...
            var events = ['hStatus', 'hMessage', 'hResult', 'attrs'];
