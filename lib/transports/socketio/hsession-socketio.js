    ...
    function(codes, sessionStorageAux){
        ...
        hSessionSocketIO.prototype.connect = function(){
            ...
            this.connect_timeout = setTimeout(function(){
                self.on_status.call(self,{status: statuses.DISCONNECTED, errorCode: errors.CONN_TIMEOUT})
        ...
        hSessionSocketIO.prototype.addListeners = function(){
            ...
            var events = ['hStatus', 'hMessage', 'hResult', 'result', 'result_error', 'attrs'];
            ...
            //Listen for errors to our requests
